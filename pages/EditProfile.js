...
import { View, Text, TouchableOpacity, TextInput, StyleSheet, ImageBackground, Picker, AsyncStorage } from 'react-native'
      ...
      return (
         <ImageBackground source={require('./img/Ashbackground.jpg')} style = {styles.background}>
            ...
            <View style={styles.picker}>
               <Picker selectedValue = {this.state.gender} onValueChange = {this.gender}>
            ...
            <TouchableOpacity
               ...
               onPress = {
                  () => this.login(this.state.gender,this.state.age, this.state.height, this.state.weight)
               }>
